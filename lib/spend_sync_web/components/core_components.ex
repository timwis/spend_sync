defmodule SpendSyncWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpendSyncWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpendSyncWeb.Gettext, "errors", msg, opts)
    end
  end
